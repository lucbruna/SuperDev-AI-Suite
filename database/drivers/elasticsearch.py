...
class ElasticsearchDriver(BaseDriver):
    """Elasticsearch driver using HTTP REST API via stdlib urllib."""
    ...
    async def connect(self, config: ConnectionConfig) -> None:
        ...
        self._logger.info(f"Elasticsearch connected at {self._base_url}")

    async def disconnect(self) -> None:
        self._connected = False
        self._logger.info("Elasticsearch disconnected")
