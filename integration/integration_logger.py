...
class IntegrationLogger:
    """Provides a structured logger bound to the integration namespace."""

    def __init__(self, name: str = "superdev.integration", level: int = logging.INFO) -> None:
    ...
    def child(self, suffix: str) -> "IntegrationLogger":
        return IntegrationLogger(f"{self._logger.name}.{suffix}", self._logger.level)
