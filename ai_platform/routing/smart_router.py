...
from ai_platform.providers.base_provider import BaseProvider, ModelInfo, ChatResponse, Choice, Usage
...
class SmartAIRouter:
    ...
    async def get_model_info(self, model_id: str) -> Optional[ModelScore]:
