"""Metrics collector for the Knowledge Graph & Enterprise Memory Engine."""
...
class EnterpriseKnowledgeMetrics:
    """In-process counters, timings and gauges."""
...
class _Timer:
    def __init__(self, metrics: EnterpriseKnowledgeMetrics,
                 name: str) -> None:
