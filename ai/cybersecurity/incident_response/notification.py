...
class NotificationSystem:
    ...
    def create_template(
        self, name: str, subject: str = "", body: str = "", channels: list[NotificationChannel] = None
    ...
    def add_escalation_rule(
        self, name: str, severity_threshold: str = "high", delay_minutes: int = 30, recipients: list[str] = None
    ) -> EscalationRule:
