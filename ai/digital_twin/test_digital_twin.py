...
# === Core Infrastructure ===
print("\n=== Core Infrastructure ===")
from digital_twin.twin_config import TwinConfig, TwinType, SyncMode
cfg = TwinConfig()
test("TwinConfig default", cfg.twin_type == TwinType.ENTERPRISE)
test("TwinConfig limits", cfg.limits.max_entities == 10000)

from digital_twin.twin_models import DigitalEntity, EntityState, SimulationConfig, SimulationState, ScenarioConfig
