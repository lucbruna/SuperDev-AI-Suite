...
class TwinEngine:
    ...
    def create_entity(
        self, name: str, entity_type: str = "generic", attributes: dict[str, Any] = None
    ) -> DigitalEntity:
    ...
    def run_simulation(self, sim_id: str) -> SimulationResult:
        ...
        if not sim:
            return SimulationResult(
                state=__import__("digital_twin.twin_models", fromlist=["SimulationState"]).SimulationState.FAILED
            )
        import time
