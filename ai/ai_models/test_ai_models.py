...
# === Core Infrastructure ===
print("\n=== Core Infrastructure ===")
from ai_models.model_config import ModelConfig, ModelLimits, CostConfig
cfg = ModelConfig()
test("ModelConfig default", cfg.default_provider.value == "openai")
test("ModelConfig limits", cfg.limits.max_tokens == 4096)

from ai_models.model_models import AIModel, ModelStatus, InferenceRequest, InferenceResponse
