...
class VectorStore:
    ...
    def __init__(self, repository: Optional[EmbeddingRepository] = None):
    ...
    def insert(self, vector_id: str, vector: List[float], metadata: Optional[Dict[str, Any]] = None) -> None:
    ...
    def update(self, vector_id: str, vector: List[float], metadata: Optional[Dict[str, Any]] = None) -> bool:
