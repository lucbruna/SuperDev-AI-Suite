...
class LearningSubEngine:
    ...
    def record_experience(self, title: str, description: str, experience_type: str = "neutral", outcome: str = "", lessons: Optional[List[str]] = None) -> Experience:
    ...
    def get_feedback(self, category: Optional[str] = None) -> List[FeedbackEntry]:
