    ...
    GRAMMARS = {
        "python": LanguageGrammar(
            ...
            keywords=["def", "class", "if", "else", "elif", "for", "while", "return",
                      ...
                      "not", "in", "is", "True", "False", "None", "self"],
        ...
        "go": LanguageGrammar(
            ...
            keywords=["func", "package", "import", "var", "const", "type", "struct",
                      ...
                      "continue", "switch", "case", "default", "select", "chan",
                      "go", "defer", "map", "make", "new", "append", "len", "cap"],
            builtins=["fmt", "strings", "math", "os", "io", "net", "http",
                     "json", "time", "context", "errors", "log"],
            constants=["true", "false", "nil", "iota"],
            single_line_comment="//",
        ),
        "rust": LanguageGrammar(
            name="rust",
            keywords=["fn", "let", "mut", "const", "struct", "enum", "impl", "trait",
                      "pub", "use", "mod", "crate", "self", "super", "if", "else",
                      "for", "while", "loop", "match", "return", "break", "continue",
                      "move", "ref", "async", "await", "unsafe", "dyn", "where",
                      "type", "static", "extern"],
            builtins=["println!", "format!", "vec!", "String", "Vec", "Option",
                     "Result", "Box", "Rc", "Arc", "Mutex", "HashMap", "HashSet"],
        ...
        "java": LanguageGrammar(
            ...
            keywords=["public", "private", "protected", "class", "interface", "enum",
                      "extends", "implements", "abstract", "static", "final", "void",
                      "int", "long", "double", "float", "boolean", "char", "byte",
                      "short", "String", "if", "else", "for", "while", "do", "switch",
                      "case", "break", "continue", "return", "try", "catch", "finally",
                      "throw", "throws", "new", "this", "super", "instanceof", "import",
                      "package"],
            builtins=["System", "String", "Integer", "Double", "Boolean", "List",
                     "Map", "Set", "ArrayList", "HashMap", "HashSet", "Arrays",
                     "Collections", "Objects", "Math", "Thread", "Exception"],
