...
# === Core App ===
print("\n=== Core App ===")
from frontend.app.config import FrontendConfig, Theme, Language, TenantConfig
cfg = FrontendConfig()
...
from frontend.app.app_core import App, create_app, AuthService, APIService
app = App()
app.initialize()
...
from frontend.app.router import Router, Route, RouteType, create_router
...
from frontend.app.providers import AppProvider, ThemeProvider, Theme as T2
...
from frontend.app.permissions import PermissionManager, Permission, Role
...
# === UI Components ===
print("\n=== UI Components ===")
from frontend.components.ui.button import Button, ButtonProps, ButtonVariant, ButtonSize
...
from frontend.components.ui.modal import Modal, ModalProps, ModalSize
...
from frontend.components.ui.tabs import Tabs, Tab, TabsProps
...
from frontend.components.editor.syntax_highlighter import SyntaxHighlighter, TokenType
sh = SyntaxHighlighter()
tokens = sh.highlight("def hello():\\n    pass", "python")
test("SyntaxHighlighter", len(tokens) > 0)

from frontend.components.editor.file_tree import FileTree, FileNode, NodeType
ft = FileTree()
...
from frontend.components.editor.suggestion_panel import SuggestionPanel, Suggestion, SuggestionType
sp = SuggestionPanel()
...
from frontend.components.ai.agent_panel import AgentPanel, AgentInfo, AgentType
ap = AgentPanel()
...
from frontend.components.ai.memory_viewer import MemoryViewer, MemoryEntry, MemoryType
mv = MemoryViewer()
mv.add_memory(MemoryEntry(id="m1", content="test", memory_type=MemoryType.SHORT_TERM))
test("MemoryViewer", len(mv.memories) == 1)

from frontend.components.ai.reasoning_view import ReasoningView, Thought, ReasoningStep
rv = ReasoningView()
...
from frontend.components.dashboard.metrics_panel import MetricsPanel, Metric, MetricType
mp = MetricsPanel()
...
from frontend.components.dashboard.agents_dashboard import AgentsDashboard, AgentDashboardInfo, AgentDashboardStatus
ad = AgentsDashboard()
...
from frontend.realtime.live_updates import LiveUpdatesManager, LiveUpdate, UpdateType
...
# === Utils ===
print("\n=== Utils ===")
from frontend.utils.formatters import format_number, format_currency, format_percentage, truncate
...
from frontend.utils.validators import is_email, is_url, is_strong_password
...
from frontend.utils.helpers import generate_id, hash_string, deep_merge, slugify
...
# === Workflow Component ===
print("\n=== Workflow Component ===")
from frontend.components.workflow.workflow_canvas import WorkflowCanvas, WorkflowNode, NodeType, WorkflowEdge
wc = WorkflowCanvas()
