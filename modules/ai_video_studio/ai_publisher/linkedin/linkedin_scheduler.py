"""LinkedIn Scheduler — best post times for LinkedIn (Volume 7)."""
...
_WINDOWS = [(8, 10), (12, 13), (17, 18)]
_BEST_DAYS = (1, 2, 3)  # Tue, Wed, Thu


class LinkedInScheduler:
    """Compute recommended LinkedIn posting slots."""
...
_SCHEDULER: LinkedInScheduler | None = None


def get_linkedin_scheduler() -> LinkedInScheduler:
    """Get the module-level singleton LinkedIn scheduler."""
    global _SCHEDULER
    if _SCHEDULER is None:
        _SCHEDULER = LinkedInScheduler()
    return _SCHEDULER
