"""Developer memory — bounded in-memory cache with LRU eviction.

Used for parsed files, intermediate results and hot lookups so repeated task
runs and queries stay fast without unbounded growth.
"""
...
class DeveloperMemory:
    ...
    def setdefault(self, key: str, default: Any) -> Any:
        """Return the value for ``key``, inserting ``default`` if missing."""
