    ...
    DEFAULT_RULES = [
        {
            ...
            "suggestion": "Use a logger instead of print()",
        },
        {
            "name": "Debug Breakpoint",
            "pattern": r"\bbreakpoint\(\)",
            "severity": 3,
        ...
        },
        {
            ...
            "pattern": r"(\"https?://localhost|\"http://0\.0\.0\.0)",
            "severity": 3,
            "message": "Hardcoded localhost or 0.0.0.0 URL",
            "suggestion": "Use environment variable for the URL",
        },
        {
            "name": "Import *",
            ...
            "suggestion": "Import only what you need: from module import Thing",
        },
        {
            ...
            "suggestion": "Consider consolidating early returns",
        },
        {
            "name": "Naked Except",
            "pattern": r"except\s*:",
        ...
        },
        {
            ...
            "severity": 1,
            "message": "console.log in frontend code",
