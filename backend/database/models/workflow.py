...
class WorkflowRun(Base):
    ...
    status: Mapped[str] = mapped_column(
        SAEnum("pending", "running", "completed", "failed", "cancelled", name="workflow_status"),
    ...
    triggered_by_user: Mapped[User | None] = relationship(
        "User", back_populates="workflow_runs", foreign_keys=[triggered_by]
    )
    ...
    agent_executions: Mapped[list[AgentExecution]] = relationship(
        "AgentExecution", back_populates="run", foreign_keys="AgentExecution.run_id"
    )
