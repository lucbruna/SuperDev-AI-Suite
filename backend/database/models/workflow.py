...
class WorkflowRun(Base):
    ...
    triggered_by: Mapped[str | None] = mapped_column(PG_UUID(as_uuid=True), ForeignKey("users.id", ondelete="SET NULL"), nullable=True)
    ...
    triggered_by_user: Mapped[User | None] = relationship("User", back_populates="workflow_runs", foreign_keys=[triggered_by])
