...
class Plugin(Base, TimestampMixin):
    ...
    status: Mapped[str] = mapped_column(
        SAEnum("installed", "enabled", "disabled", "error", name="plugin_status"),
    ...
    installed_by_user: Mapped[User] = relationship(
        "User", back_populates="installed_plugins", foreign_keys=[installed_by]
    )
