...
class KnowledgeMetrics:
    """Accumulates counters, gauges, and timing metrics for the knowledge engine."""

    def __init__(self) -> None:
        self._log = logging.getLogger("superdev.knowledge.metrics")
...
class _Timer:
    def __init__(self, metrics: KnowledgeMetrics, name: str) -> None:
